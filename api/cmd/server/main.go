...
func main() {
	...
	if err = db.AutoMigrate(&model.Host{}, &model.TerminalSession{}, &model.AISettings{}, &model.AgentTask{}, &model.AssistantConversation{}, &model.AssistantApproval{}, &model.Service{}, &model.ServiceCheck{}, &model.DatabaseConnection{}, &model.DatabaseQuery{}); err != nil {
		log.Fatal(err)
	}
